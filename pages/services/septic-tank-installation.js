  ...
  return (
    <>
      ...
      <HeroBox
        ...
        subText="Septic Tank Installation in Anne Arundel County, Baltimore County, Howard County, and Prince george's County Maryland"
        ...
        <Main>
          <div className="container">
            <section>
              ...
              <p>
                Home Septic Pros are professionals at installing septic tanks
                and septic systems.
              </p>
              <p>
              ...
              <div className="btn">
                <Button>Click For Free Estimate</Button>
              </div>
              ...
              <p>
                Wastewater leaves your house through a septic pipe and enters
                the septic tank through the inlet baffle.
              </p>
              <p>
              ...
              <p>
                The effluent is then evenly distributed to the drainfield
              ...
              <ul>
                ...
                <li>
                  You save money on property tax since you are not using the
                  city sewer.
                </li>
              </ul>
              ...
              <p>
                ...
                bathrooms, toilets and laundry room that lead to your septic
                tank.
              </p>
              <h3>Septic Tank</h3>
              <p>
                A septic tank is a watertight tank that is designed and
                designated to treat wastewater from your home. It is an
                essential component of your septic system because it holds the
                wastewater, and prevents untreated wastewater from escaping into
                the environment.
              </p>
              <p>
                There are mainly four different types of septic tanks. These
                four types are:
              </p>
              <ul>
              ...
              <p>
                Concrete tanks are also very heavy, and require heavy machinery
                to install, which can drive up the labor costs.{' '}
              </p>
              ...
              <p>
                ...
                start to rust. A rusted tank can be dangerous for the
                environment.
              </p>
              <p>
              ...
              <h3>Drain field</h3>
              <p>
                A drain field is the other essential part of a septic system.
              </p>
              ...
              <ul>
                <li>
                  1-2 bedroom home with less than 1.500 sq. ft. = 750-gallon
                  tank
                </li>
                <li>
                  3 bedroom home with less than 2,500 sq. ft. = 1,000-gallon
                  tank
                </li>
                <li>
                  4 bedroom home with less than 3,500 sq. ft. = 1,250-gallon
                  tank
                </li>
                <li>
                  5 bedroom home with less than 4,500 sq. ft. = 1,250-gallon
                  tank
                </li>
                <li>
                  6 bedroom home with less than 5,500 sq. ft. = 1,315-gallon
                  tank
                </li>
              </ul>
              <p>
                You don&apos;t usually determine the size of your tank by the
                number of people living in your house because the number of
                people living in the home can change.
              </p>
              <p>
                But on the other hand, if you have a large family and a small
                septic tank, it will not handle the volume of wastewater from
                your house.{' '}
              </p>
              <p>
              ...
              <p>
                Selecting a smaller septic tank can cause problems since the
                tank will not handle the amount of wastewater coming in.
              </p>
              <p>
              ...
              <p>
                A licensed local septic system company must submit an
                application and get approval to install the septic system.
              </p>
              <p>
              ...
              <p>
                After the application is approved, the septic system
              ...
              <p>
                Before we install your system, we first inspect all the
                materials for defects.{' '}
              </p>
              <p>
              ...
              <p>
                ...
                must be inspected by the local county officials to ensure that
                the installation is up to state and county standards.
              </p>
              <p>
              ...
              <p>
                You now have a brand new septic tank system that will last you
              ...
              <p>
                ...
                installation, septic tank permits, perform the survey, and
                perform the perc test.
              </p>
